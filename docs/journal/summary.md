...
- [2026-09-18: Direct runtime event storage](2026-09-18-runtime-event-storage.md): atomic history/deduplication/cursors and single-use control receipts; managed input, replay consumption and live permission mapping remain open.

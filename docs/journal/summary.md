...
- [2026-09-15: Shared MCP proxy](2026-09-15-shared-mcp-proxy.md): durable journal, JSONL/HTTP/SSE transport, bound HTTP calls and startup recovery; MCP session RPCs and launch integration remain in progress.

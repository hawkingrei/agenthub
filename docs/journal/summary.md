...
- [2026-09-17: Loop history storage](2026-09-17-loop-history-storage.md): scoped keyset queries and payload-free source/event pages; API, metrics, and doctor integration remain open.

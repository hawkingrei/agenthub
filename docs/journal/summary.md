...
- [2026-09-15: Shared MCP proxy](2026-09-15-shared-mcp-proxy.md): durable operation journal and raw JSONL/HTTP/SSE transport; authenticated runtime and launch integration remain in progress.

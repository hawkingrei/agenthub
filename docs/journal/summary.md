...
- [2026-09-18: Direct runtime transport](2026-09-18-rara-local-transport.md)
...
- [2026-09-18: Direct runtime event storage](2026-09-18-runtime-event-storage.md): atomic history/deduplication/cursors, single-use control receipts and typed native projection; managed input, replay consumption and live permission mapping remain open.

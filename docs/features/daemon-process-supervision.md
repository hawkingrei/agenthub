...
- Defining global start admission, retry backoff, or durable mailbox delivery receipts. Those are
  separate runtime-reliability phases. Task cancellation and join ordering are defined by

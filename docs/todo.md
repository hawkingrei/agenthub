...
- [ ] `P2` Restore fresh Cargo coverage for PRs and build the instrumented `agenthubd` prerequisite before workspace blackbox tests; the reviewed `main` coverage run fails before upload, and the prepared workflow repair needs a credential permitted to update workflows. See [journal/2026-09-06-agent-reminders.md](journal/2026-09-06-agent-reminders.md).

...
- [ ] `P1` Verify deployed Team shell route split after merge: confirm `agenthub.hawkingrei.com` selector remains a slim chooser and deployed `index.html` does not preload `route-teams`, `route-teams-workbench`, `route-teams-agent-acp`, or `route-acp-shared`. Existing notes: [journal/2026-03-21-team-ui-shell-and-bundle-refinement.md](journal/2026-03-21-team-ui-shell-and-bundle-refinement.md).

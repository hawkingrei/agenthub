...
- [ ] `P1` Finish Team mailbox phase 3: keep extending the now-enforced `requires_user_visible_reply` runtime invariant beyond the guarded `completed`, reassignment, takeover, and ignored-reason paths, then close any remaining terminal outcomes that can end human-visible work without explicit evidence. Stable contracts: [features/team-mailbox-intake-and-ownership.md](features/team-mailbox-intake-and-ownership.md) and [features/actor-foundation.md](features/actor-foundation.md). Existing notes: [journal/2026-05-20-team-mailbox-phase2-ownership-and-task-links.md](journal/2026-05-20-team-mailbox-phase2-ownership-and-task-links.md), [journal/2026-05-21-team-task-first-and-mailbox-envelope-slice.md](journal/2026-05-21-team-task-first-and-mailbox-envelope-slice.md), [journal/2026-05-31-team-mailbox-inbound-envelope-normalization.md](journal/2026-05-31-team-mailbox-inbound-envelope-normalization.md), and [journal/2026-05-31-team-mailbox-terminal-reply-evidence.md](journal/2026-05-31-team-mailbox-terminal-reply-evidence.md).

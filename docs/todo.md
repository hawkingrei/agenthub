...
- [ ] `P1` Finish Team mailbox phase 3: normalize future human/trigger/webhook intake into the canonical inbound-envelope contract, keep extending the now-enforced `requires_user_visible_reply` runtime invariant beyond the guarded `completed` path, and add explicit general transfer plus cross-actor takeover outcomes on top of the current operator-visible `watch/claim/release/ignore` triage flow and coordinator escalation path. Stable contracts: [features/team-mailbox-intake-and-ownership.md](features/team-mailbox-intake-and-ownership.md) and [features/actor-foundation.md](features/actor-foundation.md). Existing notes: [journal/2026-05-20-team-mailbox-phase2-ownership-and-task-links.md](journal/2026-05-20-team-mailbox-phase2-ownership-and-task-links.md) and [journal/2026-05-21-team-task-first-and-mailbox-envelope-slice.md](journal/2026-05-21-team-task-first-and-mailbox-envelope-slice.md).

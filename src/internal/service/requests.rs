...
impl TeamInternalControlService {
    pub(super) async fn send_actor_message_request(
        &self,
    ...
    pub(super) async fn list_actor_inbox_request(
        &self,
    ...
    pub(super) async fn ack_actor_message_request(
        &self,
    ...
    pub(super) async fn triage_actor_message_request(
        &self,
    ...
    pub(super) async fn link_actor_message_task_request(
        &self,
    ...
    pub(super) async fn describe_team_context_request(
        &self,
        ...
        let context = self
            .load_team_context(&principal, team_id, run_id, actor_id)
            .await?;
    ...
    pub(super) async fn resolve_actor_run_scope_request(
        &self,
        ...
        let resolved = if principal.loop_execution.is_some() {
            let context = self
                .load_team_context(
                    &principal,
    ...
    pub(super) async fn list_team_tasks_request(
        &self,
    ...
    pub(super) async fn create_team_task_request(
        &self,
    ...
    pub(super) async fn update_team_task_request(
        &self,
    ...
    pub(super) async fn get_team_task_request(
        &self,
    ...
    pub(super) async fn create_team_channel_request(
        &self,
    ...
    pub(super) async fn delete_team_channel_request(
        &self,
    ...
    pub(super) async fn open_team_thread_request(
        &self,
    ...
    pub(super) async fn reply_team_thread_request(
        &self,
    ...
    pub(super) async fn append_team_task_note_request(
        &self,
    ...
    pub(super) async fn create_time_trigger_request(
        &self,
    ...
    pub(super) async fn list_time_triggers_request(
        &self,
    ...
    pub(super) async fn cancel_time_trigger_request(
        &self,
    ...
    pub(super) async fn respond_permission_review_request(
        &self,
    ...
    pub(super) async fn transition_step_request(
        &self,
    ...
    pub(super) async fn issue_node_credential_request(
        &self,
    ...
    pub(super) async fn ensure_agent_record_request(
        &self,
    ...
    pub(super) async fn get_agent_record_request(
        &self,
    ...
    pub(super) async fn start_managed_agent_request(
        &self,
    ...
    pub(super) async fn stop_managed_agent_request(
        &self,
    ...
    pub(super) async fn delete_managed_agent_request(
        &self,
    ...
    pub(super) async fn send_agent_input_request(
        &self,
    ...
    pub(super) async fn send_agent_reminder_request(
        &self,
    ...
    pub(super) async fn list_agent_events_request(
        &self,

use agenthub_team_actor::{
    ACTOR_MAIN_PEER_ID, ActorSendRequest, ActorSendResponse, ActorServiceError,
    ActorServiceErrorCode,
};

use super::mailbox::{
    SendActorMessageInput, map_actor_service_error, optional_trimmed, required_trimmed_field,
};
use super::mailbox_service::TeamActorMailboxService;
use crate::team::TeamActorMessageTransport;

impl TeamActorMailboxService {
    pub(super) async fn actor_send_impl(
        &self,

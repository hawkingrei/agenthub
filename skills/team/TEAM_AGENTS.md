...
- Canonical Team reporting-surface rules live in `team-reporting-surfaces`.
- Canonical Team task create/update/note/context rules live in `team-task-governance`.

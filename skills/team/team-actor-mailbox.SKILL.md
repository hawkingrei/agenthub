...
- Worker-originated ACP permission requests should prefer a non-requester agent reviewer first and
  only fall back to leader when no peer worker is available.

...
The target release directory must contain both agenthub and agenthub-acp.
USAGE
}
...
for binary in agenthub agenthub-acp; do
...
install -m 0755 "${binary_dir}/agenthub-acp" "${package_root}/usr/bin/agenthub-acp"

...
pub fn encode_message_for_storage(stream: &OutputStream, message: &str) -> Vec<u8> {
...
pub fn decode_message_from_storage(message: &[u8]) -> String {
...
pub async fn persist_agent_event(

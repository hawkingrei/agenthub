  ...
  it("ignores stale shared-thread responses after switching teams", async () => {
    const buildTeam = (id: string, name: string) => ({
      ...
      spec: {
        ...
        entrypoint: "coordinator_plan",
        steps: [],
        members: [{ member_id: "coordinator", role: "coordinator", prompt: "Plan", skills: [] }],
      },
      created_at: 1,
      updated_at: 1,
    });
  ...
  it("restores a non-default channel route to the matching channel conversation", async () => {
    const buildTeam = (id: string, name: string) => ({
      ...
      spec: {
        ...
        entrypoint: "coordinator_plan",
        steps: [],
        members: [{ member_id: "coordinator", role: "coordinator", prompt: "Plan" }],
      },
      created_at: 1,
      updated_at: 1,
    });
  ...
  it("opens the selected agent workspace when clicking an agent in the team sidebar", async () => {
    const buildTeam = (id: string, name: string) => ({
      ...
      spec: {
        ...
        steps: [],
        members: [
          { member_id: "coordinator", role: "coordinator", prompt: "Plan" },

            ...
            <div className="space-y-1">
              ...
              {teams.length === 0 && (
                <div className="mt-2 px-2">
                  <button
                    type="button"
                    className="inline-flex h-8 items-center gap-2 rounded-md px-2 text-[12px] font-medium text-notion-text-muted transition hover:bg-notion-active-soft hover:text-notion-text"
                    onClick={onOpenCreateTeam}
                  >
            ...
            {showCreateChannelForm && onCreateChannel ? (
              ...
              >
                ...
                <div className="flex items-center justify-end gap-2">
                  <button
                    type="button"
                    className="inline-flex h-7 items-center rounded-md px-2 text-[11px] font-medium text-notion-text-muted transition hover:bg-notion-active-soft hover:text-notion-text"
                      ...
                      <span className="flex w-full items-center justify-between gap-1.5">
                        ...
                        <span className="flex shrink-0 items-center gap-1">
                          ...
                          {(member.pending_inbox_count ?? 0) > 0 && (
                            <span className="inline-flex min-w-[16px] items-center justify-center rounded-full bg-notion-hover-strong px-1 py-0.5 text-[9px] font-medium leading-none text-notion-text-muted">

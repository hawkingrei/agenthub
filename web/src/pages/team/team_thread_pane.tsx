...
export const TeamThreadPane = React.memo(function TeamThreadPane({
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3 border-b border-notion-border/70 px-4 py-3">
        <div className="min-w-0 flex-1">
          <div className="text-[13px] font-semibold tracking-tight text-notion-text">Thread</div>
          <div className="mt-0.5 text-[12px] text-notion-text-muted">
            <span>— </span>
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-y-auto px-4 py-3">
        {rootMessageId == null || !rootText ? (
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 text-[11px] text-notion-text-muted">
            ...
            <div className="rounded-xl border border-notion-border bg-white px-3 py-2.5">
              <TeamThreadRichText className="text-[13px] leading-6 text-notion-text" text={rootText} />
            </div>
            <div className="pt-2 text-[11px] leading-5 text-notion-text-muted">

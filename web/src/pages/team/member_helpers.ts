...
export const DEFAULT_TEAM_LEADER_PROMPT = [
  ...
  "Cold start policy:",
  "1. Before mailbox work, scan TODO sources (`TODO.md`, `.cache/context/TODO.md`, `.cache/context/todo.md`).",
...
export const DEFAULT_TEAM_WORKER_PROMPT = [
  ...
  "4. Do not replace leader in direct human-facing planning replies unless explicitly routed.",
  "Workflow:",

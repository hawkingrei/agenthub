...
describe("team panels interactions", () => {
  ...
  it("TeamWorkbenchContainer renders a channel profile dock and closes back to the channel", async () => {
    ...
    const flatWorkbench = {
      ...
      chatActors: {
        ...
        inboxActorId: "coordinator-agent",
      },
    ...
    const workbench: TeamWorkbenchRuntimeContext = {
      shell: {
        showTeamBootstrapLoading: flatWorkbench.showTeamBootstrapLoading,
        showTeamUnavailable: flatWorkbench.showTeamUnavailable,
        onBackToSelector: flatWorkbench.onBackToSelector,
        selectedTeam: flatWorkbench.selectedTeam,
        isAgentWorkspace: flatWorkbench.isAgentWorkspace,
        teamSectionCardClassName: flatWorkbench.teamSectionCardClassName,
        panelSecondaryButtonClassName: flatWorkbench.panelSecondaryButtonClassName,
        teamWorkbenchWorkspaceShellClassName: flatWorkbench.teamWorkbenchWorkspaceShellClassName,
        tab: "conversation",
        activeWorkspaceLens: "channels",
        developerMode: flatWorkbench.developerMode,
        busy: flatWorkbench.busy,
        selectedTeamHasConfiguredMembers: flatWorkbench.selectedTeamHasConfiguredMembers,
        selectedTeamDescription: flatWorkbench.selectedTeamDescription,
        teamMemberForgeLabel: flatWorkbench.teamMemberForgeLabel,
        teamMemberCopyExistingLabel: flatWorkbench.teamMemberCopyExistingLabel,
        onOpenTeamMemberForge: flatWorkbench.onOpenTeamMemberForge,
        onOpenTeamMemberCopyExisting: flatWorkbench.onOpenTeamMemberCopyExisting,
        showRunContextLoading: flatWorkbench.showRunContextLoading,
        showNoActiveRunNotice: flatWorkbench.showNoActiveRunNotice,
        onGoToRuns: flatWorkbench.onGoToRuns,
      },
      header: {
        workspaceEyebrow: flatWorkbench.workspaceEyebrow,
        showDedicatedWorkspaceHeading: flatWorkbench.showDedicatedWorkspaceHeading,
        workspaceTitle: flatWorkbench.workspaceTitle,
        workspaceDescription: flatWorkbench.workspaceDescription,
        selectedAgentLabel: flatWorkbench.selectedAgentLabel,
        selectedAgentWorkspaceMemberId: flatWorkbench.selectedAgentWorkspaceMemberId,
        selectedAgentStatusView: flatWorkbench.selectedAgentStatusView,
        selectedAgentSpecDraft: flatWorkbench.selectedAgentSpecDraft,
        selectedAgentControlState: flatWorkbench.selectedAgentControlState,
        showWorkspaceRuntimeBadge: flatWorkbench.showWorkspaceRuntimeBadge,
        selectedTeamRuntimeStatus: flatWorkbench.selectedTeamRuntimeStatus,
        selectedTeamRuntimeControlTone: { statusColor: "gray", countColor: "gray" },
        workspaceAdvancedTabItems: flatWorkbench.workspaceAdvancedTabItems,
        isAdvancedWorkspace: flatWorkbench.isAdvancedWorkspace,
        showRunActionsInAdvanced: flatWorkbench.showRunActionsInAdvanced,
        canResumeActiveRun: flatWorkbench.canResumeActiveRun,
        canRestartActiveRun: flatWorkbench.canRestartActiveRun,
        workspaceDetailsOpen: flatWorkbench.workspaceDetailsOpen,
        workspaceDetailItems: flatWorkbench.workspaceDetailItems,
        workspaceNoticeText: flatWorkbench.workspaceNoticeText,
        workspaceNoticeDotClassName: flatWorkbench.workspaceNoticeDotClassName,
        teamWorkbenchMutedButtonClassName: flatWorkbench.teamWorkbenchMutedButtonClassName,
        teamWorkbenchHeaderActionButtonClassName:
          flatWorkbench.teamWorkbenchHeaderActionButtonClassName,
        workspaceToolbarClassName: flatWorkbench.workspaceToolbarClassName,
        workspaceToolbarButtonActiveClassName: flatWorkbench.workspaceToolbarButtonActiveClassName,
        workspaceToolbarButtonIdleClassName: flatWorkbench.workspaceToolbarButtonIdleClassName,
        workspaceNoticeClassName: flatWorkbench.workspaceNoticeClassName,
        workspaceNoticeTextClassName: flatWorkbench.workspaceNoticeTextClassName,
        teamRunMetaItemClassName: flatWorkbench.teamRunMetaItemClassName,
        onTabChange: flatWorkbench.onTabChange,
        onToggleWorkspaceDetails: flatWorkbench.onToggleWorkspaceDetails,
        onRefreshActiveRun: flatWorkbench.onRefreshActiveRun,
        onCancelRun: flatWorkbench.onCancelRun,
        onResumeRun: flatWorkbench.onResumeRun,
        onRestartRun: flatWorkbench.onRestartRun,
        onOpenTeamMemberEditModal: flatWorkbench.onOpenTeamMemberEditModal,
        onStartSelectedTeamAgent: flatWorkbench.onStartSelectedTeamAgent,
        onStopSelectedTeamAgent: flatWorkbench.onStopSelectedTeamAgent,
        onDeleteSelectedTeamAgent: flatWorkbench.onDeleteSelectedTeamAgent,
      },
      runs: {
        onDeleteTeam: flatWorkbench.onDeleteTeam,
        runStatusFilter: "all",
        TEAM_RUN_STATUS_FILTER_OPTIONS: flatWorkbench.TEAM_RUN_STATUS_FILTER_OPTIONS,
        onRunStatusFilterChange: flatWorkbench.onRunStatusFilterChange,
        onRefreshRuns: flatWorkbench.onRefreshRuns,
        runsLoading: flatWorkbench.runsLoading,
        visibleRuns: flatWorkbench.visibleRuns,
        activeRunIdForSelectedTeam: flatWorkbench.activeRunIdForSelectedTeam,
        setActiveRunId: flatWorkbench.setActiveRunId,
        isActiveRunHiddenByFilter: flatWorkbench.isActiveRunHiddenByFilter,
        activeRunForSelectedTeam: flatWorkbench.activeRunForSelectedTeam,
        totalLoadedRunsForTeam: flatWorkbench.totalLoadedRunsForTeam,
        runsHasMore: flatWorkbench.runsHasMore,
        effectiveSelectedTeamId: flatWorkbench.effectiveSelectedTeamId,
        onLoadMoreRuns: flatWorkbench.onLoadMoreRuns,
      },
      overview: {
        snapshot: flatWorkbench.snapshot,
        snapshotLoading: flatWorkbench.snapshotLoading,
        onRefreshOverviewSnapshot: flatWorkbench.onRefreshOverviewSnapshot,
        mailboxDisplayNameByActorId: flatWorkbench.mailboxDisplayNameByActorId,
      },
      memberConsole: {
        selectedAgentWorkspaceSessionId: flatWorkbench.selectedAgentWorkspaceSessionId,
        memberEvents: flatWorkbench.memberEvents,
        memberEventsLoading: flatWorkbench.memberEventsLoading,
        memberEventsHasMore: flatWorkbench.memberEventsHasMore,
        onLoadOlderMemberConsole: flatWorkbench.onLoadOlderMemberConsole,
        onRefreshMemberConsole: flatWorkbench.onRefreshMemberConsole,
      },
      debugRun: {
        teamDebugTag: "run_ops",
        setTeamDebugTag: flatWorkbench.setTeamDebugTag,
        runContextId: flatWorkbench.runContextId,
        setRunContextId: flatWorkbench.setRunContextId,
        runInput: flatWorkbench.runInput,
        setRunInput: flatWorkbench.setRunInput,
        runLookupId: flatWorkbench.runLookupId,
        setRunLookupId: flatWorkbench.setRunLookupId,
        canCreateRun: flatWorkbench.canCreateRun,
        runInputHasError: flatWorkbench.runInputHasError,
        runInputValidation: flatWorkbench.runInputValidation,
        teamExecutionBlockedReason: flatWorkbench.teamExecutionBlockedReason,
        onCreateRun: flatWorkbench.onCreateRun,
        onLoadRunById: flatWorkbench.onLoadRunById,
        steps: flatWorkbench.steps,
        onRefreshActiveRunSteps: flatWorkbench.onRefreshActiveRunSteps,
        stepKey: flatWorkbench.stepKey,
        setStepKey: flatWorkbench.setStepKey,
        stepMemberId: flatWorkbench.stepMemberId,
        onStepMemberIdChange: flatWorkbench.onStepMemberIdChange,
        stepDependsOn: flatWorkbench.stepDependsOn,
        onStepDependsOnChange: flatWorkbench.onStepDependsOnChange,
        stepInput: flatWorkbench.stepInput,
        onStepInputChange: flatWorkbench.onStepInputChange,
        onSubmitStep: flatWorkbench.onSubmitStep,
        selectedStepId: flatWorkbench.selectedStepId,
        setSelectedStepId: flatWorkbench.setSelectedStepId,
        stepAction: "complete",
        setStepAction: flatWorkbench.setStepAction,
        stepRemoteTaskId: flatWorkbench.stepRemoteTaskId,
        onStepRemoteTaskIdChange: flatWorkbench.onStepRemoteTaskIdChange,
        stepOutput: flatWorkbench.stepOutput,
        onStepOutputChange: flatWorkbench.onStepOutputChange,
        stepFailText: flatWorkbench.stepFailText,
        onStepFailTextChange: flatWorkbench.onStepFailTextChange,
        stepInputReason: flatWorkbench.stepInputReason,
        onStepInputReasonChange: flatWorkbench.onStepInputReasonChange,
        stepInputRequiredPayload: flatWorkbench.stepInputRequiredPayload,
        onStepInputRequiredPayloadChange: flatWorkbench.onStepInputRequiredPayloadChange,
        stepResumePayload: flatWorkbench.stepResumePayload,
        onStepResumePayloadChange: flatWorkbench.onStepResumePayloadChange,
        onApplyStepAction: flatWorkbench.onApplyStepAction,
      },
      conversation: {
        unreadByMemberId: flatWorkbench.unreadByMemberId,
        chatActors: flatWorkbench.chatActors,
        chatStickToBottom: flatWorkbench.chatStickToBottom,
        chatMessagesRef: flatWorkbench.chatMessagesRef,
        onConversationScroll: flatWorkbench.onConversationScroll,
        onJumpConversationToBottom: flatWorkbench.onJumpConversationToBottom,
        conversationMessages: flatWorkbench.conversationMessages,
        onAcceptMessage: flatWorkbench.onAcceptMessage,
        onAcceptVisibleMessages: flatWorkbench.onAcceptVisibleMessages,
        onSendChatMessage: flatWorkbench.onSendChatMessage,
        MAILBOX_TEMPLATE_OPTIONS: flatWorkbench.MAILBOX_TEMPLATE_OPTIONS,
        onMailboxTemplateChange: flatWorkbench.onMailboxTemplateChange,
        onApplyMessageTemplate: flatWorkbench.onApplyMessageTemplate,
        onSendMessage: flatWorkbench.onSendMessage,
        onRefreshInbox: flatWorkbench.onRefreshInbox,
        chatDraft: flatWorkbench.chatDraft,
        onChatDraftChange: flatWorkbench.onChatDraftChange,
      },
      memberAcp: {
        selectedAgentWorkspaceSnapshot: flatWorkbench.selectedAgentWorkspaceSnapshot,
        selectedMemberSnapshot: flatWorkbench.selectedMemberSnapshot,
        selectedAgentWorkspaceRuntimeMember: flatWorkbench.selectedAgentWorkspaceRuntimeMember,
        selectedAgentWorkspaceAgent: flatWorkbench.selectedAgentWorkspaceAgent,
        oldestMemberEventId: flatWorkbench.oldestMemberEventId,
        onSendAgentAcpInput: flatWorkbench.onSendAgentAcpInput,
        onCancelTeamMemberAcp: flatWorkbench.onCancelTeamMemberAcp,
        onSetTeamMemberAcpMode: flatWorkbench.onSetTeamMemberAcpMode,
        onSetTeamMemberAcpModel: flatWorkbench.onSetTeamMemberAcpModel,
        onSetTeamMemberAcpConfig: flatWorkbench.onSetTeamMemberAcpConfig,
        onForceNewTeamMemberSession: flatWorkbench.onForceNewTeamMemberSession,
        memberTargetNodeById: flatWorkbench.memberTargetNodeById,
        selectedMemberId: flatWorkbench.selectedMemberId,
        setSelectedMemberId: flatWorkbench.setSelectedMemberId,
        selectedMemberDiscoveryCard: flatWorkbench.selectedMemberDiscoveryCard,
        selectedMemberDiscoveryCardLoading: flatWorkbench.selectedMemberDiscoveryCardLoading,
        onOpenMailboxForMember: flatWorkbench.onOpenMailboxForMember,
      },
      events: {
        eventsLoading: flatWorkbench.eventsLoading,
        oldestEventId: flatWorkbench.oldestEventId,
        displayedRunEvents: flatWorkbench.displayedRunEvents,
        previewMode: flatWorkbench.previewMode,
        eventsAutoRefresh: flatWorkbench.eventsAutoRefresh,
        setEventsAutoRefresh: flatWorkbench.setEventsAutoRefresh,
        onRefreshEventsPanel: flatWorkbench.onRefreshEventsPanel,
        onLoadOlderEventsPanel: flatWorkbench.onLoadOlderEventsPanel,
        eventsHasMore: flatWorkbench.eventsHasMore,
        TEAM_EVENT_PREVIEW_LIMIT: flatWorkbench.TEAM_EVENT_PREVIEW_LIMIT,
      },
      mailboxDebug: {
        msgFromActorId: flatWorkbench.msgFromActorId,
        onMsgFromActorIdChange: flatWorkbench.onMsgFromActorIdChange,
        msgToActorId: flatWorkbench.msgToActorId,
        onMsgToActorIdChange: flatWorkbench.onMsgToActorIdChange,
        msgChannel: flatWorkbench.msgChannel,
        onMsgChannelChange: flatWorkbench.onMsgChannelChange,
        msgTransport: "local",
        onMsgTransportChange: flatWorkbench.onMsgTransportChange,
        msgRoute: flatWorkbench.msgRoute,
        onMsgRouteChange: flatWorkbench.onMsgRouteChange,
        msgTemplate: flatWorkbench.msgTemplate,
        msgPayload: flatWorkbench.msgPayload,
        onMsgPayloadChange: flatWorkbench.onMsgPayloadChange,
        msgIdempotencyKey: flatWorkbench.msgIdempotencyKey,
        onMsgIdempotencyKeyChange: flatWorkbench.onMsgIdempotencyKeyChange,
        inboxActorId: flatWorkbench.inboxActorId,
        onInboxActorIdChange: flatWorkbench.onInboxActorIdChange,
        inboxLimit: flatWorkbench.inboxLimit,
        onInboxLimitChange: flatWorkbench.onInboxLimitChange,
        inboxAfterId: flatWorkbench.inboxAfterId,
        onInboxAfterIdChange: flatWorkbench.onInboxAfterIdChange,
        inboxIncludeDelivered: flatWorkbench.inboxIncludeDelivered,
        onInboxIncludeDeliveredChange: flatWorkbench.onInboxIncludeDeliveredChange,
        mailboxHasActiveRun: flatWorkbench.mailboxHasActiveRun,
        mailboxEmptyTitle: flatWorkbench.mailboxEmptyTitle,
        mailboxEmptyBody: flatWorkbench.mailboxEmptyBody,
      },
    };
    const workspaceContext: TeamWorkspaceContextValue = {
      selectedConversation: null,
              ...
              notes: [
                {
                  ...
                  kind: "decision",
                  text: "Keep the rollout checklist and handoff log on the task journal.",
                  created_at: 226,
                },
                {
                  message_id: 8,
  ...
  it("TeamTasksPanel filters and sorts by priority", async () => {
    act(() => {
      root.render(
        <MantineProvider>
          <TeamTasksPanel
    ...
    const cardsBeforeFilter = Array.from(

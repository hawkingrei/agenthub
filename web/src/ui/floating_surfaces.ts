...
export const NOTION_FLOATING_MENU_CLASSNAMES: NonNullable<MenuProps["classNames"]> = {
  dropdown: `min-w-[220px] ${NOTION_FLOATING_LIST_PANEL_CLASS}`,
  label:
    "px-2.5 pt-1.5 pb-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-notion-text-muted",
  item:
    "min-h-7 rounded-md px-2.5 py-1.5 text-[13px] font-medium leading-5 text-notion-text transition data-[hovered]:bg-notion-hover data-[hovered]:text-notion-text data-[disabled]:opacity-45 data-[disabled]:bg-transparent",

...
const CONVERSATION_BUBBLE_BASE_CLASS =
  "mt-0.5 min-w-0 max-w-full overflow-hidden rounded-[16px] border border-black/5 px-3 py-2 shadow-[0_1px_2px_rgba(15,23,42,0.04)]";
...
const COMPACT_BUTTON_BASE_CLASS =
  "inline-flex items-center rounded-md px-1.5 py-0.5 text-[10px] font-medium tracking-[0.01em] text-notion-text-muted transition hover:bg-[rgba(55,53,47,0.05)] hover:text-notion-text active:translate-y-px disabled:cursor-not-allowed disabled:opacity-50";
const COMPACT_ICON_BUTTON_BASE_CLASS =
  "inline-flex h-5 min-w-5 items-center justify-center rounded-md p-0.5 text-[10px] font-medium text-notion-text-muted transition hover:bg-[rgba(55,53,47,0.05)] hover:text-notion-text active:translate-y-px disabled:cursor-not-allowed disabled:opacity-50";

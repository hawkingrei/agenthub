...
import {
  ...
  getToolPayloadParseStats,
  resetToolPayloadParseStats,
...
export function getToolContentCacheStats(): ToolContentCacheStats {
  const payloadStats = getToolPayloadParseStats();
  return {
    ansiHits: ansiCacheHitCount,
    ansiMisses: ansiCacheMissCount,
    payloadParses: payloadStats.payloadParses,
    payloadParseFailures: payloadStats.payloadParseFailures,
  };
}
